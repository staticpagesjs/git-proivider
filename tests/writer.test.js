...
const generatedFileContents = 'Generated by @static-pages/gitio test runner. This file can be deleted safely.';
...
// test('it writes a simple data object to git with a renderer', async () => {
// 	const write = writer({
// 		cwd: outputDir,
